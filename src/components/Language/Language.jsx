...
const Language = () => {
    return (
        <>
            <h1 className="text-center text-6xl font-bold mb-9">Languages.</h1>
            <div className="max-w-screen-xl bg-slate-800 text-white rounded-xl py-5 mx-auto lg:ml-28 border grid grid-cols-1 md:grid-cols-3">
